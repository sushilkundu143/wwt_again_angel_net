...
render(){
    return(
        ...
        <p style={{fontSize:13,fontWeight:'bold'}}>I want a startup idea in agriculture</p>
        ...
        <div style={{display:'flex',flexDirection:'column',marginRight:20}}>
        <p>Investor</p>
        <p>Idea or a startup in ideation phase</p>
        <p>Agriculture</p> 
        </div>
        </div>
        ...
        I am a CEO of Agri-need pvt ltd and i have worked in this field for 5 years , and i am here for looking for some new fascinating startup ideas
